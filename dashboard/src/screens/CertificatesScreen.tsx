  ...
  const columns: Column<Certificate>[] = [
    {
      ...
      render: (c) => (
        <div>
          <h5 className="font-bold text-white hover:text-suraksha-amber transition">{c.workerName}</h5>
          <p className="text-[10px] text-suraksha-subtext">{c.employeeId} • {c.sector}</p>
        </div>
      ),
    },
    {
      ...
      sortable: true,
      render: (c) => <span className="font-mono text-xs font-semibold text-suraksha-amber">{c.certificateId}</span>,
    },
    {
      key: 'moduleName',
      header: 'Safety Qualification',
      sortable: true,
      render: (c) => <span className="text-xs font-medium text-white">{c.moduleName}</span>,
    },
    {
      key: 'resultGrade',
      header: 'Grade / Score',
      align: 'center',
      render: (c) => <span className="text-xs font-bold text-emerald-400">{c.resultGrade}</span>,
    },
    {
      key: 'issueDate',
      header: 'Issue Date',
      sortable: true,
      render: (c) => <span className="text-[11px] text-suraksha-subtext">{c.issueDate}</span>,
    },
    {
      key: 'expiryDate',
      header: 'Expiration Date',
      sortable: true,
      render: (c) => <span className="text-[11px] text-suraksha-subtext">{c.expiryDate}</span>,
    },
    {
      key: 'status',
      header: 'Status',
    ...
    },
    {
      ...
      render: (c) => (
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg border border-suraksha-border bg-suraksha-surface text-xs font-semibold text-white hover:bg-suraksha-hover transition"
        >
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
        <div className="p-4 rounded-xl border border-suraksha-border bg-suraksha-card">
          ...
          <p className="text-2xl font-black text-emerald-400 mt-1">11,850 Active</p>
        </div>
        <div className="p-4 rounded-xl border border-suraksha-border bg-suraksha-card">
          <p className="text-[10px] font-bold text-suraksha-subtext uppercase">Expiring in 30 Days</p>
          <p className="text-2xl font-black text-amber-400 mt-1">412 Due</p>
        </div>
        <div className="p-4 rounded-xl border border-suraksha-border bg-suraksha-card">
          <p className="text-[10px] font-bold text-suraksha-subtext uppercase">Expired</p>
          <p className="text-2xl font-black text-rose-400 mt-1">86 Lapsed</p>
        </div>
        <div className="p-4 rounded-xl border border-suraksha-border bg-suraksha-card">
