...
namespace SurakshaAR.Screens
{
    ...
    public class GasScenarioSelectionController : IScreenController
    {
        ...
        public void OnShow(GameObject root, object param)
        {
            ...
            {
                titleLbl.text = loc.Get("gas.module.title");
            }
            ...
            {
                introTitle.text = loc.Get("gas.module.title");
            }
            ...
            {
                introDesc.text = loc.Get("gas.module.desc");
            }
            ...
            if (_cardScenario1 != null)
            {
                ...
                if (c1Title != null && loc != null) c1Title.text = loc.Get("scenario.gas.underground.title");
                var c1Desc = _cardScenario1.transform.Find("Inner/TextCol/Desc")?.GetComponent<TextMeshProUGUI>();
                if (c1Desc != null && loc != null) c1Desc.text = loc.Get("scenario.gas.underground.desc");
            }

            // Card 2: 02 Confined Space Entry
            ...
            if (_cardScenario2 != null)
            {
                ...
                if (c2Title != null && loc != null) c2Title.text = loc.Get("scenario.gas.confined.title");
                var c2Desc = _cardScenario2.transform.Find("Inner/TextCol/Desc")?.GetComponent<TextMeshProUGUI>();
                if (c2Desc != null && loc != null) c2Desc.text = loc.Get("scenario.gas.confined.desc");
            }

            // Card 3: 03 Gas Cylinder Leak
            ...
            if (_cardScenario3 != null)
            {
                ...
                if (c3Title != null && loc != null) c3Title.text = loc.Get("scenario.gas.cylinder.title");
                var c3Desc = _cardScenario3.transform.Find("Inner/TextCol/Desc")?.GetComponent<TextMeshProUGUI>();
                if (c3Desc != null && loc != null) c3Desc.text = loc.Get("scenario.gas.cylinder.desc");
            }
